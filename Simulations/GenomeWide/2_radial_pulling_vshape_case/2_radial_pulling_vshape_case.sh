lmpfile=2_radial_pulling_vshape_case.lmp
run=100000
dump=10000
...
do
    replicadir=replica_${replica} #_R_${R}_run_${run}
    ...
    cat ../../1_create_mitotic_links_vshape_case/replica_${replica}/1_create_mitotic_links_replica_${replica}.txt | awk '{if(NF==9){print $1,$2,$3,$4,$5+0,$6,$7,$8,$9;next};{if($3=="xlo" || $3=="ylo" || $3=="zlo"){print -300.00,300.00,$3,$4;next};print $0}}' > simulation_replica_${replica}
