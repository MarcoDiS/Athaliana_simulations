...
#include"/home/devel/mstefano/personal_C_libraries/My_Memory.c"
#include"/home/devel/mstefano/personal_C_libraries/My_IO.c"
...
double distance_between_points(double *P1, double *P2, int dim, double particle_contact_distance)
{
  ...
  for(k = 0; k < dim; ++k)
    {
      distance += (P1[k]-P2[k])*(P1[k]-P2[k]);
      if(distance > particle_contact_distance) return(10000.);
    }
  if(distance > particle_contact_distance) return(10000.);
